# About translating FramesAndNodes

> [!NOTE]
> All commands **must** be run in `./freecad/FramesAndNodes/resources/translations/` directory.
...
at <https://crowdin.com/project/freecad-addons> webpage and find the **FramesAndNodes** project.

## Creating file for missing locale

To create a file for a new language with all **FramesAndNodes** translatable strings execute
...
once done, look for the **FramesAndNodes** project.
...
Now you can contribute your translated `.ts` file to **FramesAndNodes** repository,
also include the `.qm` file.

<https://github.com/me/FramesAndNodes>
